...
def build_or_remove_doctypes(config,inst):
    ...
    for doctype in doctypes:
        ...
        insert_function_details("Send_RT_Ticket", "Sends an RT Ticket")
        ...
        insert_function_into_submission_at_step_and_score(doctype, "SBI", "Send_RT_Ticket", "1", "80")
        ...
        insert_function_into_submission_at_step_and_score(doctype, "SBI", "Print_Success", "1", "100")
